...
namespace HelloWorld
{
    ...
    class Program
    {
        ...
        private static void DisplayGame()
        {
            ...
            areEqual = String.Compare("Hello", "hello", true) == 0; //true ignore case bool
            ...
            input = input.TrimStart(); //strips whitespace, can strip more
            input = input.TrimEnd();
            input = input.Trim();
        ...
        private static bool ReadBoolean( string message )
        {
            do
            {
                ...
                /*switch (result)
                {
                    case "Y": //leave off statement to fall through
                    return true;
